        ...
        <Container fluid = "xs">
            ...
            >
                ...
                <Col xs= {12} md={12} lg ={5} className="movieInfo p-4 animated fadeInRightBig">
                    ...
                    ? <span onClick = { () => getFavouriteMovies(movieInfo)} className = "add-to-favourites"> 
                    <input className="btn btn-danger" type='Button' value='Add To Fav' id='addfav'/>
                    </span>
                    :null
                    }
                   <br/>
            ...
            <Container>
                ...
                </Row>
                {
                    ...
                    (
                        ...
                        text = {(actors.length - visible) + ' More Players! Click to see '}
